        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-8">
            <div className="flex items-center space-x-2 group">
              <div
                className={`w-6 h-6 bg-white ${prefersReducedMotion ? "" : "transition-transform duration-300 group-hover:rotate-180"}`}
                style={{
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                description: "Light up your wardrobe with our Electric Dreams Collection. Vibrant colors for the bold.",
                  ...
                  >
                    <div
                      className={`w-32 h-32 bg-gradient-to-r ${collection.accent} rounded-lg opacity-80 ${
                        prefersReducedMotion ? "" : "transition-all duration-500 group-hover:scale-110"
                      }`}
                      style={{ willChange: prefersReducedMotion ? "auto" : "transform" }}
                    >
                      {index === 1 && (
              ...
              >
                <CardContent className="p-0">
                  ...
                  >
                    {product.content && (
                      <div
                        className={`${prefersReducedMotion ? "" : "transition-all duration-500 group-hover:scale-110"}`}
                      >
                        {index === 0 && (
                          <div className="w-20 h-24 bg-green-400 rounded-lg flex items-center justify-center">
                            <div
                              className={`text-xs text-green-900 font-mono ${prefersReducedMotion ? "" : "animate-pulse"}`}
                            >
                              {product.content}
                            </div>
                          </div>
                        ...
                        {index === 1 && (
                          <div className="w-24 h-28 bg-blue-600 rounded-lg flex items-center justify-center">
                            <div className={`text-white text-lg ${prefersReducedMotion ? "" : "animate-bounce"}`}>
                              {product.content}
                            </div>
                          </div>
                        )}
                        {index === 3 && (
                          <div className="w-28 h-8 bg-gray-600 rounded-full flex items-center justify-center">
                            <div
                              className={`text-xs text-white font-mono ${prefersReducedMotion ? "" : "animate-pulse"}`}
                            >
                              {product.content}
                            </div>
                          </div>
