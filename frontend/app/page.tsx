              ...
              <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
                <div className={`text-center z-10 ${animationClasses.hero}`}>
                  <h1 className={`text-5xl font-bold mb-4 ${prefersReducedMotion ? "" : "animate-pulse"}`}>
                    <span className={`inline-block ${prefersReducedMotion ? "" : "hover:scale-110 transition-transform duration-300"}`}>
                      Sube
                    </span>{" "}
                    <span className={`inline-block ${prefersReducedMotion ? "" : "hover:scale-110 transition-transform duration-300"}`}>
                      de
                    </span>{" "}
                    <span className={`inline-block text-[#7847eb] ${prefersReducedMotion ? "" : "hover:scale-110 transition-transform duration-300"}`}>
                      Nivel
                    </span>{" "}
                    <span className={`inline-block ${prefersReducedMotion ? "" : "hover:scale-110 transition-transform duration-300"}`}>
                      tu
                    </span>{" "}
                    <span className={`inline-block text-cyan-400 ${prefersReducedMotion ? "" : "hover:scale-110 transition-transform duration-300"}`}>
                      Estilo!
                    </span>
                  </h1>
            ...
            {[
              ...
              >
                <CardContent className="p-0">
                  <div className={`relative h-64 bg-gradient-to-br ${collection.accent} flex items-center justify-center overflow-hidden`}>
                    <div
                    ...
                    >
                      {index === 1 && (
                        <div className="w-full h-full flex items-center justify-center">
                          <div className={`text-2xl font-bold text-gray-800 ${prefersReducedMotion ? "" : "animate-bounce"}`}>
                            👕
                          </div>
                        </div>
                      )}
      ...
      {!isLoaded && (
        <div className="fixed inset-0 bg-[#171221] z-50 flex items-center justify-center">
          <div className="text-center">
            <div className={`w-16 h-16 border-4 border-[#7847eb] border-t-transparent rounded-full mb-4 ${prefersReducedMotion ? "" : "animate-spin"}`}></div>
            <p className={`text-[#a394c7] ${prefersReducedMotion ? "" : "animate-pulse"}`}>
